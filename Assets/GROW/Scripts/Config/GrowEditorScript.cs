...
namespace Grow
{
	...
	public class GrowEditorScript : ScriptableObject
	{
		...
		static string currentModuleVersion = "3.1.7";
		...
		static GrowEditorScript() {
			// do this to make sure everything is initialized without opening editor
			var editorInstance = GrowEditorScript.Instance;
			editorInstance.GrowSettings = new ObjectDictionary();
			var gameKey = GrowEditorScript.HighwayGameKey;
			var envKey = GrowEditorScript.HighwayEnvKey;
